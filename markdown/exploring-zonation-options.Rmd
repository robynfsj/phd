...
percentage abundance of taxa based only on abundant taxa. I have therefore done 
the same throughout this document. This should have been the first question I 
addressed but there was no need to show the differences that occur in the 
dendrograms because of this as I would never have considered doing it the way I 
had originally thought because it is not the done thing. 
